...
class Zookeeper:
    ...
    # 4. clean(fence: Fence) (Pulizia dei recinti): implementare un metodo che 
    # consenta al guardiano dello zoo di pulire tutti i recinti dello zoo.
...
animal1 = Animal("Gino","maiale",12,11,11,"Tropicale")
animal2= Animal("fsdino","maiale",12,31,11,"Tropicale")
fence_1 = Fence(122, 26, "tropicale", [animal1,animal2])
fence_2 = Fence(122, 26, "tropicale", [animal1,animal2])
fences = [fence_1,fence_2]
zookeeper1 = Zookeeper("gino","pino", "12") 
zookeeper2 = Zookeeper("morandi","pino", "52")
zookepers = [zookeeper1,zookeeper2]
zoo1 = Zoo(fences,zookepers)
zoo1.describe_zoo()
